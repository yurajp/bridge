...
func PrepareDb() error {
  ...
  defer db.Close()
  create := fmt.Sprintf(`create table if not exists %s (title text, url text, date text) without rowid`, lkTable)
  fmt.Println("  Creating ", lkTable)
